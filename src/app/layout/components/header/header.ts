...
export class Header {
  ...
  navItems = [
    ...
    { label: 'header.nav.sellProperty', route: '/sell-property' },
    { label: 'header.nav.favorites', route: '/favorites' },
    { label: 'header.nav.projects', route: '/projects' },
    { label: 'header.nav.about', route: '/about-us' },
    { label: 'header.nav.blog', route: '/blog' },
    { label: 'header.nav.contact', route: '/contact-us' },
  ];
  openSignIn() {
